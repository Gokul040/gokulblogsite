...
public class StepSkipListener implements SkipListener<Category, Number> {
    ...
    public void onSkipInProcess(Category asset, Throwable throwable) {
        logger.info("Item {}  was skipped due to the exception  {}", new ObjectMapper().writeValueAsString(asset),
